...
export default function Footer() {
  return (
    <footer className="relative bg-dark-900 pt-20 pb-10 overflow-hidden">
      {/* Background gradient */}
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-16">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-gray-400 max-w-xs">
              AI-powered personal finance dashboard. Upload your bank statement and get instant insights.
            </p>
          </div>
